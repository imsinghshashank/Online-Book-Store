...
<head>
    ...
    <style>
        ...
        /* Signup container responsiveness */
        .signup-container {
            max-width: 400px;
            margin: auto;
            padding: 24px;
...
<body>
    ...
    <div class="signup-container">
        ...
        <c:if test="${sessionScope.isUserLoggedIn}">
            <p class="text-center text-lg text-gray-700">You are already logged in as <c:out value="${sessionScope.loggedInUser.username}"/>. Please log out to register a new account.</p>
            <p class="mt-4 text-center">
                <a href="/logout" class="text-blue-600 hover:underline">Logout (<c:out value="${sessionScope.loggedInUser.username}"/>)</a>
            </p>
        </c:if>
        <c:if test="${sessionScope.isAdminLoggedIn && !sessionScope.isUserLoggedIn}">
            <p class="text-center text-lg text-gray-700">You are logged in as an administrator. Please log out of your admin session to register a new user.</p>
            <p class="mt-4 text-center">
